...
public class ControlEspacial : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            animator.SetBool("Correndo1", true);
        }

        else
        {
            animator.SetBool("Correndo1", false);
        }
        if (Input.GetAxis("Fire1") != 0)
        {
            animator.SetBool("Atirando1", true);
        }

        else
        {
            animator.SetBool("Atirando1", false);
        }
